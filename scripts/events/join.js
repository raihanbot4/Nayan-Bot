...
module.exports.onLoad = function () {
	...
	const path2 = join(__dirname, "Nayan", "salam.mp4");
...
◑কিন্তু আমাকে কন্ট্রোল করার জন্য প্রয়োজন আমার বস রায়হান কে🤙

◑মেম্বারদের সব কমান্ড আমার পক্ষে পালনকরা সম্ভব না 😔

◑আমার বস রায়হান কে এড দিতে প্রথমে টাইপ করুন -adduser তারপর একটা স্পেস দিয়ে বস এর Uid 61552312071816 দিন ☺️

◑ ফেসবুক লিংক ☞ https://www.facebook.com/profile.php?id=61552312071816
...
`, attachment: fs.createReadStream(__dirname + "/Nayan/salam.mp4")} ,threadID));
	}
	else {
		try {
			...
			const randomPath = readdirSync(join(__dirname, "Nayan", "salam.mp4"));

			if (existsSync(pathGif)) formPush = { body: msg, attachment: createReadStream(pathGif), mentions }
			else if (randomPath.length != 0) {
				const pathRandom = join(__dirname, "Nayan", "salam.mp4", `${randomPath[Math.floor(Math.random() * randomPath.length)]}`);
