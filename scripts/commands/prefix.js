...
module.exports.handleEvent = async ({ api, event }) => {
  ...
  const dipto2 = event.body ? event.body.toLowerCase() : '';
    const GP = "ðŸ¤âœ¨ð‘ðŽððŽð“ ðð‘ð„ð…ðˆð—âœ¨ðŸ¤";
     let d1PInfo = await api.getThreadInfo(event.threadID);
  let diptoName = d1PInfo.threadName;
    var time = moment.tz("Asia/Dhaka").format("LLLL");
  const text = `â•­â€¢â”„â”…â•â•â•âðŸŒºââ•â•â•â”…â”„â€¢â•®\n${GP}\nâ•°â€¢â”„â”…â•â•â•âðŸŒºââ•â•â•â”…â”„â€¢â•¯\n\nððŽð“ ðð€ðŒð„ : ${global.config.BOTNAME}\nð‘ðŽððŽð“ ðð‘ð„ð…ðˆð— : ï½¢ ${global.config.PREFIX} ï½£\nð‘ðŽððŽð“ ð‚ðŒðƒ: ï½¢ ${client.commands.size} ï½£\nð“ðˆðŒð„ : ${time}\nð†ð‘ðŽð”ð ðð€ðŒð„: ${diptoName}\n`
